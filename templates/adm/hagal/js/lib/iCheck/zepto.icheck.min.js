...
n(d)),d==k&&c[l]==s&&c.name)){g=a.closest("form");var j='input[name="'+c.name+'"]',j=g.length?g.find(j):h(j);j.each(function(){this!==c&&h(this).data(m)&&x(h(this),d)})}c[q]&&f(a,v,!0)&&b.find("."+m+"-helper").css(v,"default");b[r](I||f(a,d)||"");b[t](C||f(a,e)||"")}function x(a,d,g){var c=a[0],b=a.parent(),e=d==q?"enabled":"un"+k,h=f(a,e+n(c[l])),j=f(a,d+n(c[l]));!1!==c[d]&&!g&&(c[d]=!1,a.trigger("ifChanged").trigger("if"+n(e)));!c[q]&&f(a,v,!0)&&b.find("."+m+"-helper").css(v,"pointer");b[t](j||
f(a,d)||"");b[r](h||f(a,e)||"")}function F(a,d){a.data(m)&&(a.parent().html(a.attr("style",a.data(m).s||"").trigger(d||"")),a.off(".i").unwrap(),h('label[for="'+a[0].id+'"]').add(a.closest("label")).off(".i"))}function f(a,d,g){if(a.data(m))return a.data(m).o[d+(g?"":"Class")]}function n(a){return a.charAt(0).toUpperCase()+a.slice(1)}h.fn[m]=function(a,d){var g=navigator.userAgent,c=/ipad|iphone|ipod/i.test(g),b='input[type="'+z+'"], input[type="'+s+'"]';if(/^(check|uncheck|toggle|disable|enable|update|destroy)$/.test(a))return this.each(function(){var c=
h(this);(c.is(b)?c:c.find(b)).each(function(){c=h(this);"destroy"==a?F(c,"ifDestroyed"):A(c,!0,a);h.isFunction(d)&&d()})});if("object"==typeof a||!a){var e=h.extend({checkedClass:k,disabledClass:q,labelHover:!0},a),f=e.handle,n=e.hoverClass||"hover",v=e.focusClass||"focus",G=e.activeClass||"active",H=!!e.labelHover,D=e.labelHoverClass||"hover",y=(""+e.increaseArea).replace("%","")|0;if(f==z||f==s)b='input[type="'+f+'"]';-50>y&&(y=-50);return this.each(function(){var a=h(this);(a.is(b)?a:a.find(b)).each(function(){a=
