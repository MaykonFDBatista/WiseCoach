/* [ ---- Hagal Admin - common js ---- ] */
        ...
        init: function() {
            ...
            var jPM = $.jPanelMenu({
                ...
                afterClose: function() {
                    ...
                    $.cookie("hagal_side_jpanel", "false")
                }
            });
            ...
            var conteudo_jpanel = $('#conteudo_jpanel').html();
            if(cookie_jpanel == "true" && conteudo_jpanel.trim() != '') {
                jPM.open(false);
            }; 
    ...
    hagal_scroll_top = {
        init: function() {
            $('body').append('<div id="nav_up" class="hidden-print" style="cursor:pointer;z-index:1000;font-size:16px;display:none;position:fixed;bottom:8px;right:14px"><i class="elusive-icon-chevron-up"></i></div>');
