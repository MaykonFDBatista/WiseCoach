...
<div class="box_a">
    ...
    <div class="box_a_content cnt_a">
        ...
        <?php
            echo form_open($url, array('class' => 'form-horizontal', 'id' => 'form_edita_grupo'));

            // Carrega a view com o conteudo do formulario
            $this->load->view($this->config->item('admin') . 'content/forms/grupo_editar');
        ?>
        <div class="formSep">
